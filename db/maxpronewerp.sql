...
--
-- Host: localhost
-- Generation Time: Jul 11, 2018 at 09:05 AM
...
CREATE TABLE `mxp_booking_challan` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `mrf_quantity` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `mxp_booking_challan` (`id`, `user_id`, `booking_order_id`, `erp_code`, `item_code`, `item_size`, `item_description`, `item_quantity`, `item_price`, `matarial`, `gmts_color`, `others_color`, `orderDate`, `orderNo`, `shipmentDate`, `poCatNo`, `created_at`, `updated_at`, `mrf_quantity`) VALUES
...
(1, 49, '2L.HT-CR.001', NULL, 'sadsads', 'dhamaka', '21-OST2LHTCR001X-02', '1.01', '7400', '097', 'asdasd', 'asdasd', 'asdasd', 'sadasd', '1', '2018-04-17 00:19:18', '2018-07-10 01:32:01', 'create', ''),
...
(49, 'shohidur', NULL, 'Rahman', NULL, 'super_admin', 0, 0, 'sohidurr49@gmail.com', '$2y$10$.JwEQcEC.OTXRG4aP/PsU.iomnby.5ndA35BeOVrh2Mb03x1LMlsS', '01792755683', '21FxInOkxwbDKbs4OhluK6KWDs8GPBNeKGLeJiryjpaHBJTewOQC3u79iIWK', 1, 1, 0, '0', '2018-04-09 04:17:47', '2018-04-09 04:17:47'),
...
--
ALTER TABLE `mxp_menu`
  MODIFY `menu_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;
...
--
ALTER TABLE `mxp_translations`
  MODIFY `translation_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=557;

--
-- AUTO_INCREMENT for table `mxp_translation_keys`
--
ALTER TABLE `mxp_translation_keys`
  MODIFY `translation_key_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=279;
