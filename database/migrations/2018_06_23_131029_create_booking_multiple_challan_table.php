...
class CreateBookingMultipleChallanTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mxp_booking_multipleChallan', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('mxp_booking_multipleChallan');
    }
}
