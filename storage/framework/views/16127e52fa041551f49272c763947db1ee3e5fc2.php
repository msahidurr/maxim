        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><?php echo e(trans('others.add_header_label')); ?></div>
                    <div class="panel-body">

                   
                        <form class="form-horizontal" action="<?php echo e(Route('page_header_save')); ?>" enctype="multipart/form-data" role="form" method="POST" >
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="header_type" >
                                            <option value="<?php echo e(old('header_type')); ?>"><?php echo e((11 == old('header_type'))?'Company Info':(12 == old('header_type'))?'Booking':''); ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control  input_required" name="header_title" value="<?php echo e(old('header_title')); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-6">
                                      <select class="form-control" id="sel1" name="header_fontsize">
                                        <option value="<?php echo e(old('header_fontsize')); ?>"><?php echo e(old('header_fontsize')); ?></option>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-6">
                                      <select class="form-control" id="sel1" name="header_fontstyle">
                                        <option value="<?php echo e(old('header_fontstyle')); ?>"><?php echo e(old('header_fontstyle')); ?></option>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-6">
                                      <select class="form-control" id="sel1" name="header_colour">
                                        <option value="<?php echo e(old('header_colour')); ?>"><?php echo e(old('header_colour')); ?></option>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-6">
                                      <select class="form-control" id="sel1" name="logo_allignment">
                                        <option value="<?php echo e(old('logo_allignment')); ?>"><?php echo e(old('logo_allignment')); ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="address3" value="<?php echo e(old('address3')); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="cell_number" value="<?php echo e(old('cell_number')); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="attention" value="<?php echo e(old('attention')); ?>">
                                    </div>
                                </div>
