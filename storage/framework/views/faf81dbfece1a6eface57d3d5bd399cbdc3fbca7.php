<?php $__env->startSection('page_heading','Add Product List'); ?>
                            ...
                            <div class="row">
                            	<div class="col-sm-6">
		                            ...
		                            <div class="form-group">
		                                ...
		                                <div class="col-md-6">
		                                    <input type="text" class="form-control  input_required" name="p_description" value="<?php echo e(old('p_description')); ?>">
		                                </div>
		                            </div>
		                            ...
		                            <div class="form-group">
		                               ...
		                               <div class="col-md-6">
		                                    <select class="form-control input_required" name="p_brand" value="">                   
		                            ...
		                            <div class="form-group">
		                                ...
		                                <div class="col-md-6">
		                                    <input type="text" class="form-control  input_required" name="p_unit_price" value="<?php echo e(old('p_unit_price')); ?>">
		                                </div>
		                            </div>
                            	</div>
                            	...
                            	<div class="col-sm-6">
                            		<div class="form-group">
		                                ...
		                                <div class="col-md-6">
		                                    <input type="text" class="form-control  input_required" name="p_weight_qty" value="<?php echo e(old('p_weight_qty')); ?>">
		                                </div>
		                            </div>
		                            ...
		                            <div class="form-group">
		                                ...
		                                <div class="col-md-6">
		                                    <input type="text" class="form-control  input_required" name="p_weight_amt" value="<?php echo e(old('p_weight_amt')); ?>">
		                                </div>
		                            </div>
		                            ...
		                            <div class="form-group">
		                                ...
		                                <div class="col-md-6">
		                                    <input type="text" class="form-control  input_required" name="p_description1" value="<?php echo e(old('p_description1')); ?>">
		                                </div>
		                            </div>
		                            ...
		                            <div class="form-group">
		                                ...
		                                <div class="col-md-6">
		                                    <input type="text" class="form-control  input_required" name="p_description2" value="<?php echo e(old('p_description2')); ?>">
		                                </div>
		                            </div>
		                            ...
		                            <div class="form-group">
		                                ...
		                                <div class="col-md-6">
		                                    <input type="text" class="form-control  input_required" name="p_description3" value="<?php echo e(old('p_description3')); ?>">
		                                </div>
		                            </div>
		                            ...
		                            <div class="form-group">
		                                ...
		                                <div class="col-md-6">
		                                    <input type="text" class="form-control  input_required" name="p_description4" value="<?php echo e(old('p_description4')); ?>">
		                                </div>
		                            </div>
