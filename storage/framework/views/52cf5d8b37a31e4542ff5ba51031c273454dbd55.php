...
<table class="table table-bordered">
    ...
    <tbody>
    	<?php
    		...
    		$BDTandUSD = 0;
    	 ?>
    	 	<?php $__currentLoopData = $orderValue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $counts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    	 		<?php
    	 			$count = 1;
    	 			$rowspanValue += $count ; 
    	 		 ?>
    	 	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    		<?php $__currentLoopData = $orderValue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

    			<?php
    				$totalQty =0;
    				$itemsize = explode(',', $item->itemSize);  				
    				$qty = explode(',', $item->quantity);
    				$unitPrice = explode(',', $item->unitPrice);
    				// print_r($unitPrice);
    				$itemlength = 0;
    			...
    			?>
	    			...
	    			<tr>
	    				...
	    				<!-- <?php for($ik; $ik<=0; $ik++): ?> -->
	    				<!-- <?php endfor; ?> -->
	    				<td rowspan=""><?php echo e(isset($item->oss)?$item->oss:''); ?></td>
	    				
			    		<td rowspan="<?php echo e($itemlength); ?>"><?php echo e(isset($item->style)?$item->style:''); ?></td> 
				    		...
				    		<?php endif; ?>			    		   
			    		<td rowspan="<?php echo e($itemlength); ?>">
			    		</td>
			    		
			    		<?php 
    						$totalAllQty += $totalQty;
    						$UsdAmount = $totalQty * 2;//$item->unit_price;
