                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" action="<?php echo e(Route('party_save_action')); ?>" role="form" method="POST" >
                            ...
                            <div class="row">
                                <div style="margin-left: -140px;" class="col-md-12">
                                    <div class="form-group">
                                        <label class="col-md-5 control-label"><?php echo e(trans('others.party_id_label')); ?></label>
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="party_id" value="<?php echo e(old('party_id')); ?>">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-5 control-label"><?php echo e(trans('others.party_name_label')); ?></label>
                                        <div class="col-md-6">
                                            <input type="text" class="form-control  input_required" name="name" value="<?php echo e(old('name')); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-5 control-label"><?php echo e(trans('others.sort_name_label')); ?></label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-5 control-label"><?php echo e(trans('others.name_buyer_label')); ?></label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                      <label class="col-md-5 control-label"><?php echo e(trans('others.header_status_label')); ?></label>
                                      <div class="col-md-6">
                                        ...
                                        <div class=" panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control  input_required" name="address_part_1_invoice" value="<?php echo e(old('address_part_1_invoice')); ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control  input_required" name="address_part_2_invoice" value="<?php echo e(old('address_part_2_invoice')); ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control  input_required" name="attention_invoice" value="<?php echo e(old('attention_invoice')); ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control  input_required" name="mobile_invoice" value="<?php echo e(old('mobile_invoice')); ?>">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control  input_required" name="address_part_1_delivery" value="<?php echo e(old('address_part_1_delivery')); ?>">
                                                    </div>
                                                </div> 
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control  input_required" name="address_part_2_delivery" value="<?php echo e(old('address_part_2_delivery')); ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control  input_required" name="attention_delivery" value="<?php echo e(old('attention_delivery')); ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control  input_required" name="mobile_delivery" value="<?php echo e(old('mobile_delivery')); ?>">
                                                    </div>
                                                </div>
